...
def plot_precision_bar(datasets, vgg16_data, resnet34_data, mobilenet_data, 
    ...
    # ===== 坐标轴设置 =====
    ax.set_xlabel('数据集', fontsize=13, labelpad=10)
    ax.set_ylabel('精确率 (%)', fontsize=13, labelpad=10)
    ax.set_xticks(x)
...
def plot_recall_bar(datasets, vgg16_data, resnet34_data, mobilenet_data,
    ...
    # ===== 坐标轴设置 =====
    ax.set_xlabel('数据集', fontsize=13, labelpad=10)
    ax.set_ylabel('召回率 (%)', fontsize=13, labelpad=10)
    ax.set_xticks(x)
    ax.set_xticklabels(datasets, fontsize=12)
    ax.tick_params(axis='both', labelsize=11)
    ax.set_ylim(0, 108)
...
def plot_f1_bar(datasets, vgg16_data, resnet34_data, mobilenet_data,
    ...
    # ===== 坐标轴设置 =====
    ax.set_xlabel('数据集', fontsize=13, labelpad=10)
    ax.set_ylabel('F1分数 (%)', fontsize=13, labelpad=10)
    ax.set_xticks(x)
    ax.set_xticklabels(datasets, fontsize=12)
    ax.tick_params(axis='both', labelsize=11)
    ax.set_ylim(0, 108)
...
def plot_all_metrics_together(datasets, precision_data, recall_data, f1_data,
    ...
    ax1.set_xlabel('数据集', fontsize=11)
    ax1.set_ylabel('精确率 (%)', fontsize=11)
    ax1.set_xticks(x)
    ...
    ax1.set_title('(a) 精确率对比', fontsize=12, pad=10)
    ...
    ax2.set_ylabel('召回率 (%)', fontsize=11)
    ax2.set_xticks(x)
    ax2.set_xticklabels(datasets, fontsize=10, rotation=15)
    ax2.set_ylim(0, 108)
    ax2.legend(loc='upper right', fontsize=8)
    ax2.grid(axis='y', linestyle='--', alpha=0.3)
    ax2.spines['top'].set_visible(False)
    ax2.spines['right'].set_visible(False)
    ax2.set_title('(b) 召回率对比', fontsize=12, pad=10)
    ...
    ax3.set_ylabel('F1分数 (%)', fontsize=11)
    ax3.set_xticks(x)
    ax3.set_xticklabels(datasets, fontsize=10, rotation=15)
    ax3.set_ylim(0, 108)
    ax3.legend(loc='upper right', fontsize=8)
    ax3.grid(axis='y', linestyle='--', alpha=0.3)
    ax3.spines['top'].set_visible(False)
    ax3.spines['right'].set_visible(False)
    ax3.set_title('(c) F1分数对比', fontsize=12, pad=10)
...
def main():
    ...
    # ===== 3. 精确率数据 =====
    # 格式：每个列表包含三个数据集上的数据，顺序与 datasets 一致
